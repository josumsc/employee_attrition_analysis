...
After our first iteration, we saw that there are many variables not relevant to our model, so we decide to drop them and construct a new model without taking them into consideration:
...
log_cm = table(test[, 2], log_pred > 0.33)
log_cm
